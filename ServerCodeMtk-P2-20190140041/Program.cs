...
namespace ServerCodeMtk_P2_20190140041
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
               ...
               ServiceMetadataBehavior(); //Service Runtime Player
                smb.HttpGetEnabled = true; //untuk mengaktifkan wsdl (dibuka saat development, tidak untuk dibuka) hostObj.Description.Behaviors.Add(smb);
                //mex
                Binding mexbind =
